...
6. **Zamontuj urządzenia** — Hub skierowany ku słońcu, na wysokości 1-2 m nad ziemią, nachylony 30–50° względem poziomu; Scale na stabilnym podłożu w zasięgu do 35 m od Huba; VitalSensor w ulu, w górnym rogu centralnej ramki pszczelej, do 35 m od Huba.
7. **Kontroluj regularnie** — korzystaj z monitoringu 24/7, alarmów i rekomendacji w aplikacji Apisense.

W razie problemów sprawdź baterie i łączność, znajdź problem na [Lista problemów i proponowane rozwiązania](troubleshooting.md#1-lista-problemow-i-proponowane-rozwiazania) lub skontaktuj się z pomocą Apisense **[bee@apisense.ai](mailto:bee@apisense.ai)**.
