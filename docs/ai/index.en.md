...
- **Weather for your apiaries** — the Assistant automatically pulls the weather forecast for the **specific location** of each of your apiaries. You do not need to give a city — the Assistant knows where your hives are.
- **Apisense beekeeping knowledge base** — bee diseases (Varroa, Nosema, foulbrood), recommended treatment timing, best practices for apiary management. Materials prepared by Apisense experts.
- **Official Apisense system manuals** — the full documentation for device configuration (Hub, Scale, VitalSensor), the Apisense Pro AI app manual, account and notifications settings. When you ask "how do I set a scale alarm" or "how do I connect a new gateway" — the Assistant answers directly from our documentation.
- **Apisense videos on YouTube** — when there is an **official Apisense video tutorial** for your question, the Assistant adds a specific link to the video in its answer — in your language, if a localised version is available.
