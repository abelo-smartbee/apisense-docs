...
- **Your conversations are saved**, so you can come back to them at any time from **Session history** and view them in a read-only preview.
...
3. **Rate the conversation** — in the app you will find a rating button (thumbs up/down). Your feedback helps improve the Assistant.
4. **Start a new conversation** — if the conversation context started leading in the wrong direction, a clean conversation gives you a fresh start.
5. **Report a serious issue** — through the contact channel indicated in the app.
